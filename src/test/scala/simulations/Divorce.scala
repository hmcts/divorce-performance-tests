...
class Divorce extends Simulation
    ...
    val testAssertions = ArrayBuffer(global.failedRequests.count.lessThan(1),
        ...
        details("/njurisdiction/habitual-residence Redirect 1").responseTime.max.lessThan(expectedMaxResponseTime),
        details("/njurisdiction/domicile").responseTime.max.lessThan(expectedMaxResponseTime),
        details("/njurisdiction/domicile Redirect 1").responseTime.max.lessThan(expectedMaxResponseTime),
        details("/njurisdiction/last-habitual-residence").responseTime.max.lessThan(expectedMaxResponseTime),
        details("/njurisdiction/last-habitual-residence Redirect 1").responseTime.max.lessThan(expectedMaxResponseTime),
        details("/njurisdiction/interstitial").responseTime.max.lessThan(expectedMaxResponseTime),
        details("/njurisdiction/interstitial Redirect 1").responseTime.max.lessThan(expectedMaxResponseTime),
