...
object ReasonForDivorce {
    ...
    /* val reason = exec(http("DIV01_280_ReasonForDivorce")
     ...
     val adulteryCoRespondentAddress = exec(http("DIV01_310_AdultryCoRespondantAddress")
         ...
         .exec(http("DIV01_320_AdultryCoRespondantPostcode")
             .post("/about-divorce/reason-for-divorce/adultery/co-respondent-address")
             .formParam("selectAddressIndex", "5")
             .formParam("addressType", "postcode")
         ...
         .exec(http("DIV01_330_AdultryCoRespondantAddressTosendThePetition")
             .post("/about-divorce/reason-for-divorce/adultery/co-respondent-address")
             .formParam("addressLine0", "8 Balfour Road")
             .formParam("addressLine1", "Hounslow")
             .formParam("addressLine2", "TW3 1JX")
             .formParam("addressType", "postcode")
    ...
    val reason = exec(http("DIV01_280_ReasonForDivorce")
      .post("/about-divorce/reason-for-divorce/reason")
      .formParam("reasonForDivorce", "unreasonable-behaviour")
      .formParam(csrfParameter, csrfTemplate)
      .formParam("submit", "Continue")
      .check(status.is(200))
      .check(currentLocation.is(baseurl + "/about-divorce/reason-for-divorce/unreasonable-behaviour"))
      .check(CsrfCheck.save))
      .pause(continuePause)

    val behaviouralReasonDescription=

        exec(http("DIV01_290_Behavioural_Reason")
          .post("/about-divorce/reason-for-divorce/unreasonable-behaviour")
          .formParam(csrfParameter, csrfTemplate)
          .formParam("reasonForDivorceBehaviourDetails[]", "My husband is not giving money for shopping, not cooking for me")
          .formParam("reasonForDivorceBehaviourDetails[]", "My husband is not taking me holiday...")
          .formParam("reasonForDivorceBehaviourDetails[]", "My husband ...")
          .formParam("reasonForDivorceBehaviourDetails[]", "My husband ...")
          .formParam("reasonForDivorceBehaviourDetails[]", "My husband ...")
          .formParam("reasonForDivorceBehaviourDetails[]", "My husband ...")
          .formParam("submit", "Continue")
